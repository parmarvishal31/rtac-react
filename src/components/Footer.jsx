...
function Footer() {
  return (
    <div className='flex w-full justify-center items-center rounded-t-lg'>
        ...
        <div className=' w-full flex justify-center items-center gap-1 font-semibold border-r-2 border-black text-white bg-gray-700'><span className='text-red-500'><PiPhoneCallFill /></span><span>Call Now</span></div>
