      ...
      <div className="p-4 flex justify-center items-center flex-col gap-2">
        ...
        <div>
          <div className="flex gap-2 mt-2">
            <Link
              to="https://www.instagram.com/rtac_official?igsh=MXBnb2tqMjlpamR2aw=="
              className="rounded-full bg-red-500 p-2 shadow-lg cursor-pointer"
            >
              <FaInstagram className="text-white text-2xl" />
            </Link>
            <Link
              to="https://www.facebook.com/profile.php?id=61555670246235&mibextid=ZbWKwL"
              className="rounded-full bg-blue-500 p-2 shadow-lg cursor-pointer"
            >
              <FaFacebook className="text-white text-2xl" />
            </Link>
            <Link
              to="https://www.linkedin.com/in/rtac-education-329a862bb?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app"
